 ...
 */
public class Field_Code implements Serializable {
     ...
     *  
     */
    private String FIELD_CONCEPTUALDOMAIN_ID ;
    ...
    public String getFIELD_CONCEPTUALDOMAIN_ID() {
        return FIELD_CONCEPTUALDOMAIN_ID;
    }

    public void setFIELD_CONCEPTUALDOMAIN_ID(String FIELD_CONCEPTUALDOMAIN_ID) {
